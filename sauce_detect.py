...
def contour_finding(gray_image):
    test_path = "rice_test/new_images_2_17/results_gray/"
    for root, dirs, files in os.walk(test_path):
        ...
        if item.endswith(".jpg") or item.endswith(".JPG"):
            ...
            cv2.imwrite('rice_test/new_images_2_17/results_contour/' + item, im)
            ...
            return row_cmt[0], col_cmt[0]


test_path = "rice_test/new_images_2_17/images/"
roi = cv2.imread('rice_test/new_images_2_17/sauce/sauce.png')
...
for root, dirs, files in os.walk(test_path):
    for item in files:
        if item.endswith(".jpg") or item.endswith(".JPG"):
            ...
            # my_file = open('rice_test/new_images_2_17/txt_results/match_3.txt','a')
            ...
            cv2.imwrite("rice_test/new_images_2_17/results/" + item, res)
            ...
            cv2.imwrite("rice_test/new_images_2_17/results_gray/" + item, gray_res)

            # Meanshift

            r, c = contour_finding(item)
            w, h = 780, 780
            ...
            cv2.imwrite("rice_test/new_images_2_17/results_mean_shift/" + item, target)
